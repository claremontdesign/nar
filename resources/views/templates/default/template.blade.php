...
<html lang="en">
	<head>
		...
		<link rel='stylesheet' id='woocommerce_prettyPhoto_css-css'  href='{{ cd_nar_asset('plugins') }}/woocommerce/assets/css/prettyPhoto.css' type='text/css' media='all' />
		<link rel='stylesheet' id='woocommerce-layout-css'  href='{{ cd_nar_asset('plugins') }}/woocommerce/assets/css/woocommerce-layout.css' type='text/css' media='all' />
		<link rel='stylesheet' id='woocommerce-smallscreen-css'  href='{{ cd_nar_asset('plugins') }}/woocommerce/assets/css/woocommerce-smallscreen.css' type='text/css' media='only screen and (max-width: 768px)' />
		<link rel='stylesheet' id='woocommerce-general-css'  href='{{ cd_nar_asset('plugins') }}/woocommerce/assets/css/woocommerce.css' type='text/css' media='all' />
		...
		<script type='text/javascript' src='{{ cd_nar_asset('jquery.js') }}'></script>
		...
		<link rel='stylesheet' id='toko-style-css'  href='{{ cd_nar_asset('all.css') }}' type='text/css' media='all' />
		<link rel='stylesheet' id='toko-style-css'  href='{{ cd_nar_asset('nar.css') }}' type='text/css' media='all' />
		@yield('head_bottom')
	</head>
	<body class="@yield('body_class')">
		...
		<script type='text/javascript' src='{{ asset('assets/claremontdesign/cdbase.js') }}'></script>
		<script type='text/javascript' src='{{ cd_nar_asset('all.js') }}'></script>
		@yield('body_bottom')
	</body>
</html>
